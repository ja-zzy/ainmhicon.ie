...
export default function Footer() {
    return (
        <footer className='w-full grid grid-cols-3 grid-rows-1 p-10 bg-base-300'>
            ...
            <section className='prose prose-md flex flex-col items-center text-center justify-center'>
                <p>Copyright Ainmhicon 2026</p>

                <p>Ainmhícon, Company Limited by Guarantee, Company No. 793565</p>
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2381.3135191246683!2d-6.404527722599578!3d53.35554377229208!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x486772dbc7d4f509%3A0x99f42331b285eb66!2sClayton%20Hotel%20Liffey%20Valley!5e0!3m2!1sen!2suk!4v1780135186334!5m2!1sen!2suk" width='400px' height='300px' loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
            </section>
        </footer >
    );
}
