        ...
        <div className="flex flex-col flex-1 items-center">
            <div className="w-full bg-base-100 px-5">
                <article className="prose prose-xl m-auto py-10 text-center text-neutral-content">
                    <h1 className="text-5xl sm:text-[2.8em] text-shadow-[0_0_3px_black]">FAQ</h1>
                    <h2 className='text-shadow-[0_0_2px_black]'>Registration</h2>
                    ...
                    <h2 className='text-shadow-[0_0_2px_black]'>Attendance</h2>
                    ...
                    <h2 className='text-shadow-[0_0_2px_black]'>Payments and Cancellations</h2>
