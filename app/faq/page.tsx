            ...
            <div className="w-full bg-base-100 px-5">
                <article className="prose prose-xl m-auto py-10 text-center text-neutral-content">
                    ...
                    <div className="join join-vertical bg-accent overflow-hidden radius rounded-4xl w-full shadow-2xl">
                        ...
                        <div className="collapse collapse-arrow join-item border-base-300 border">
                            <input type="radio" name="my-accordion-4" />
                            <div className="collapse-title font-semibold text-left">What do I get for my registration fee?</div>
                    ...
                    <div className="join join-vertical bg-accent overflow-hidden radius rounded-4xl w-full shadow-2xl">
                        <div className="collapse collapse-arrow join-item border-base-300 border">
                            <input type="radio" name="my-accordion-4" />
                            <div className="collapse-title font-semibold text-left">What is the age for attendance?</div>
                        ...
                        <div className="collapse collapse-arrow join-item border-base-300 border">
                            <input type="radio" name="my-accordion-4" />
                            <div className="collapse-title font-semibold text-left">What happens if I do not have a valid form of ID?</div>
                    ...
                    <div className="join join-vertical bg-accent overflow-hidden radius rounded-4xl w-full shadow-2xl">
                        <div className="collapse collapse-arrow join-item border-base-300 border">
                            <input type="radio" name="my-accordion-4" />
                            <div className="collapse-title font-semibold text-left">How do you accept payments?</div>
