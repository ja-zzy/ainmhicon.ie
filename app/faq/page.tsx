        ...
        <div className="flex flex-col flex-1 items-center">
            <div className="w-full bg-base-100 px-5">
                <article className="prose prose-xl m-auto py-10 text-center text-neutral-content">
                    <div className="card card-lg sm:card-xl bg-base-200 pb-12">
                        <h1 className="text-5xl sm:text-[2.8em] pt-8">FAQ</h1>

                        <div className="divider w-[50%] mx-auto"></div>

                        <h2>Registration</h2>

                        <div className="join join-vertical bg-accent overflow-hidden radius rounded-4xl mx-10 shadow-2xl">
