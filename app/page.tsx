    ...
    <div className="flex flex-col flex-1 items-center">
      ...
      <div className="w-full bg-base-100">
        <article className="prose prose-xl m-auto py-10 px-4 text-center">
          ...
          <p className="font-bold">Ainmhícon is thrilled to welcome you back to for it's second year in Clayton Hotel Liffey Valley. Join us as we lay down our roots and celebrate nature and our wonderful community!</p>
          <div className="divider w-[50%] mx-auto"></div>
          <p className="font-bold">Events schedule coming soon!</p>
          <div className="divider w-[50%] mx-auto"></div>
          <p className="font-bold">Dealer's Den Applications will open on 3<sup>rd</sup> August 2026! See the <a href='/dealers-den#applications'>Dealer's Den</a> page for more info.</p>
          <div className="divider w-[50%] mx-auto"></div>
          <p className="font-bold">Ticket sales will begin soon! In order to buy a ticket and provide us your registration info, you will need an account. You can set up your account at <a href='https://reg.ainmhicon.ie'>any time</a></p>
          <div className="divider w-[50%] mx-auto"></div>
        </article>
      </div>
      ...
      <div className="card bg-base-200 card-lg shadow-sm w-[90vw] md:w-[70vw]  max-w-275 lg:card-side my-20">
        ...
        <figure className="min-w-[50%] block lg:hidden">
          <img alt="Craic and Ceol playing a games console on a television" src='/game.gif' />
        </figure>
