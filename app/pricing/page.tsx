            ...
            <div className="w-full bg-base-100 text-center">
                <article className=" prose prose-xl m-auto py-10 w-[90vw] md:w-[70vw]  max-w-205">
                    <div className="card bg-base-200 card-lg shadow-sm m-auto">
                        <h1 className="text-5xl sm:text-[2.8em] pt-8">Registration & Pricing</h1>
                ...
                <article className='m-auto px-10 m-w-full group py-10'>
                    <div className="card bg-base-200 card-lg shadow-sm m-auto pt-4 pb-8">
                ...
                <article className='py-10 w-[90vw] md:w-[70vw] max-w-205 m-auto'>
                    <div className='prose-lg bg-base-200 py-8 rounded-t-box w-full'>
                        <h2>Hotel and Accommodation</h2>
                    </div>
                    <div className="card bg-base-200 card-lg shadow-sm lg:card-side m-auto rounded-t-none">
