        ...
        <div className="flex flex-col flex-1 items-center">
            <div className="w-full bg-base-100 px-5  text-center">
                ...
                <article className='m-auto px-3 m-w-full group'>
                    ...
                    <div className='grid grid-cols-1 auto-rows-auto md:grid-cols-3 md:grid-rows-1 md:auto-rows-auto justify-center gap-6 m-auto max-w-100 md:max-w-300'>
                        ...
                        <div className="card bg-accent shadow-lg rounded-xl overflow-hidden scale-100 hover:scale-110 transition-transform duration-250">
                            <div className="card-body p-0 gap-0">
                                <div className="flex flex-col">
                                    <h2 className="text-2xl font-light bg-(--color-base-400) text-neutral-content m-0! py-2">FOUNDER</h2>
                ...
                <article >
                    ...
                    <div className="card bg-base-200 card-lg shadow-sm w-fit  lg:card-side m-auto">
                        ...
                        <div className="card-body prose prose-lg">
                            <p>Need a place to stay during the convention? Then our venue, <a href='https://www.claytonhotels.com/liffey-valley/'>Clayton Hotel Liffey Valley</a>, is the place to stay!For the 11th and 12th of April 2026 they are providing reduced prices for con goers. The hotel sports a 20m Pool & Club Vitae Leisure Centre, 349 Rooms & Suites (including accessible rooms on request) and parking available at €6 per night.The hotel has a large car park. The overnight charge is €10 per vehicle, hours 0-2 are free and after 2 hours it is €3.00 per hour.The discount code for the hotel will be provided after registration payment is completed.</p>
